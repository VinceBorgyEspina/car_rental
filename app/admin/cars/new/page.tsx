  ...
  return (
    <div>
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-white">Add New Car</h1>
          <p className="text-sm text-[var(--color-dark-300)]">Add a new vehicle to your fleet</p>
        </div>
      </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div>
                ...
                <select id="transmission" name="transmission" required className="input-field w-full">
              ...
              <div>
                ...
                <select id="fuelType" name="fuelType" required className="input-field w-full">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  name="features"
                  type="text"
                  placeholder="GPS Navigation, Heated Seats, Sunroof, Apple CarPlay"
                  className="input-field w-full"
                />
              </div>
